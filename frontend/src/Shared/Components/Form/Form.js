...
class Form extends Component {
  ...
  _getInvalidErr(domEl) {
    ...
    if (domEl.type === "email" && domEl.validity.typeMismatch)
    ...
    if (domEl.validity.patternMismatch && domEl.pattern === REGEX_TEL)
      return ERR_MSG.P_TEL;
    if (domEl.validity.patternMismatch && domEl.pattern === REGEX_DATE)
      return ERR_MSG.P_DATE;
    return "Got err";
  }
